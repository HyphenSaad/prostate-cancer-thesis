...
!python "prostate-cancer-thesis/scripts/create_patches.py" --patch-size 512 --stride-size 512 --save-masks True --stitching True --selective-slides True --selective-slides-csv "prostate-cancer-thesis/data_splits/train_{BATCH_NUMBER}.csv" --output-base-directory "output_{BATCH_NUMBER}"
