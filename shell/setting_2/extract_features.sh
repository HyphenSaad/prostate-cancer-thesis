...
!python "prostate-cancer-thesis/scripts/extract_features.py" --encoder "resnet50" --output-base-directory "output_{BATCH_NUMBER}" --dataset-base-directory "prostate-cancer-thesis" --dataset-info-file-name "train.csv" --patch-size 512
